    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/valoraciones/validar", "/api/valoraciones/responder").permitAll()
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/valoraciones/*").permitAll()
                        .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/valoraciones/*/responder").permitAll()
                        ...
                        .requestMatchers("/api/vecino/perfil", "/api/vecino/perfil/**").hasRole("VECINO")
                        ...
                        .requestMatchers("/api/qr/vecino/**").hasRole("VECINO")
